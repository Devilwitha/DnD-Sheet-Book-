...
def test_system_info_screen(mock_disk_usage, mock_virtual_memory, mock_cpu_percent, mock_get_folder_size, mock_get_screen_resolution, mock_get_os_version, mock_get_model, test_app):
